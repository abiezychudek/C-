...
class Game
{
    ...
    void NewGame()
    {
        ...
        hero = NewHero();
        Console.Clear();
       Console.WriteLine("{0} {1} let's start the  adventure",
                  char.ToUpper(hero.Type.ToString()[0]) + hero.Type.ToString().Substring(1),
                  hero.Name);
    ...
    void TalkTo(NonPlayerCharacter npc, DialogParser parser)
    {
        ...
        while (dialog != null)
        {
            ...
            Console.WriteLine("How are you going to response?");
            int i = 1;
            ...
            do
            {
                ...
                Console.Error.WriteLine("Wrong number my friend");
            }
            while (true);
        }
    }
